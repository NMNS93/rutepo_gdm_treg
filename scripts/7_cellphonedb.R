...
figdir <- fs::dir_create("gdm/figures/cellphonedb")
...
tde <- fread("gdm/results/treg_within_cluster_de.csv.gz")
...
# CellphoneDB plots ----
library(ktplots)
pvals <- read.delim("gdm/results/cellphonedb/case/degs_analysis_relevant_interactions_09_28_2024_140844.txt")
means <- read.delim("gdm/results/cellphonedb/case/degs_analysis_means_09_28_2024_140844.txt")
decon <- read.delim("gdm/results/cellphonedb/case/degs_analysis_deconvoluted_09_28_2024_140844.txt")
obj <- seurat_case
...
# Control
pvals <- read.delim("gdm/results/cellphonedb/control/degs_analysis_relevant_interactions_09_28_2024_142839.txt")
pvals <- read.delim("gdm/results/cellphonedb/control/degs_analysis_interaction_scores_09_28_2024_142839.txt")
means <- read.delim("gdm/results/cellphonedb/control/degs_analysis_means_09_28_2024_142839.txt")
decon <- read.delim("gdm/results/cellphonedb/control/degs_analysis_deconvoluted_09_28_2024_142839.txt")
obj <- seurat_control
...
# Stat CASE
pvals <- read.delim("gdm/results/cellphonedb_stat/statistical_analysis_pvalues_09_28_2024_182652.txt")
rel <- fread("gdm/results/cellphonedb/case/degs_analysis_relevant_interactions_09_30_2024_025638.txt")
pints <- fread("gdm/results/cellphonedb/case/degs_analysis_interaction_scores_09_30_2024_025638.txt")
sints <- fread("gdm/results/cellphonedb/case/degs_analysis_deconvoluted_percents_09_30_2024_025638.txt")
smeans <- fread("gdm/results/cellphonedb/case/degs_analysis_significant_means_09_30_2024_025638.txt")
means <- fread("gdm/results/cellphonedb/case/degs_analysis_means_09_30_2024_025638.txt")
decon <- fread("gdm/results/cellphonedb/case/degs_analysis_deconvoluted_09_30_2024_025638.txt")
obj <- seurat_case
...
data.table::fwrite(res, "gdm/results/case_cellphonedb.csv")
