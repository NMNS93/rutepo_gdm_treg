# Assign subtypes from manually updated CSV files. Subtypes are informed by exploratory figures from 2_subtyping.R
...
cd4_labels <- "gdm/data/cd4_labels_v3.csv"
file.edit(cd4_labels)
treg_labels <- "gdm/data/treg_labels_v3.csv"
file.edit(treg_labels)
...
# Save average expression per cluster for each gene to use in downstream heatmap
